...
const LuckyWheelGuide = ({ open, onClose }: { open: boolean; onClose: () => void }) => {
  const lang = i18n.language;

  if (lang === "vi") {
    return (
      <Modal footer={null} width={300} open={open} onCancel={onClose} centered title="Hướng dẫn trò chơi">
        <p>Mỗi ngày, bạn sẽ được tặng <b>1 lượt quay miễn phí</b>.</p>
        <p>Mỗi lượt quay có thể mang đến những phần quà hấp dẫn.</p>
        <p>Nếu không có lượt miễn phí, bạn có thể quay với giá <b>0.2 $</b>.</p>
        <p style={{ fontStyle: 'italic', color: '#888' }}>Chúc bạn may mắn và vui vẻ khi chơi!</p>
      </Modal>
    );
  } else if (lang === "en") {
    return (
...
export default LuckyWheelGuide;
